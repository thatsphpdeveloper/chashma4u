        ...
        <div class="content-wrapper">
            <div class ="row">
              ...
              <div class="col-9 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Employee Detail <?='<span class="'.$employeeData->class.' ml-1">'.$employeeData->status.'</span>';?>
                      <div class="btn-group pull-right" role="group" aria-label="Basic example">
                        <a href="<?=DASHURL.'/admin/employee/add/'.$employeeData->employeeId?>"  class="btn btn-success">Edit</a>
                        <a href="<?=DASHURL.'/'.$this->sessDashboard?>/employee/add" class="btn btn-success pull-right">Add New</a>
                        <a href="<?=DASHURL.'/'.$this->sessDashboard?>/employee/employeelist" class="btn btn-success pull-right">Employee List</a> 
                      </div> </h4>
