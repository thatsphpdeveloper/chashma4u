        ...
        <div id="addTabModel" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <form class="forms-sample formarea" method="post" action="" novalidate enctype="multipart/form-data" onSubmit="return validateSubCategory(this, event);">
                    <p class="msg"></p>
                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <input type="text" class="form-control firstinput" id="subCategoryName" name="subCategoryName" placeholder="Enter category name" required>
                    </div>
                    <div class="form-group col-lg-12">
                            <label for="slugName">Sub Category Slug</label>
                            <input type="text" class="form-control firstinput" id="slugName" name="slugName" placeholder="Enter sub category slug name">
                    </div>
                    <div class="form-group col-lg-12">
